...
<div class="container pb-5">
    <main role="main" class="pb-3">
        <h2>New Diagnostic Form</h2><br>
    </main>
</div>
<?php $getPatientID = $_GET['patID'];?>
<div class="row">
    <div class="col-6">
    <form method="post" action=<?php echo "\"sql/sql-diagnostic-create.php?patID={$getPatientID}\"" ?>>
            ...
            <div class="form-group col-md-4">
                <?php include_once('dd_list/diagnostic.php'); ?>
            </div>

            <div class="form-group col-md-6">
                <label class="control-label labelFont">Suggested Treatment</label>
                <input class="form-control" type="text" name="treat_type" required>
            </div>

            <div class="form-group col-md-6">
                <label class="control-label labelFont">Notes</label>
                <input class="form-control" type="text" name="diag_notes">
            </div>

            <div class="form-group col-md-6">
                <label class="control-label labelFont">Diagnostic Date</label>
                <input class="form-control" type="date" name="diag_date" required>
            </div>
