                ...
                <div class="main-content">
                    ...
                    <div class="staff-content">
                        <div class="list-toolbar">
                            <a class="new-employee" href="employee-create.php">New Employee</a>
                        ...
                        <div class ="listing">
                            ...
                            <?php
                                while ($obj = $resultEmployee -> fetch_object()) {
                                    echo "<tr>";
                                    echo "<td><a class=\"go\" href=\"employee-details.php?empID={$obj->EmployeeID}\">Select</a></td>";
                                    ...
                                    echo "<td><a class=\"update\" href=\"employee-update.php?empID={$obj->EmployeeID}\">Update</a><br><a class=\"delete\" href=\"sql/sql-employee-delete.php?empID={$obj->EmployeeID}\">Delete</a></td>";
                                    echo "</tr>";
                                }
                            ?>
                        </div>
