...
<div class="container pb-5">
    <main role="main" class="pb-3">
        <h2>Update Employee: <?php echo $emp_firstname;?> <?php echo $emp_lastname; ?></h2><br>
    </main>
</div>
<div class="row">
    <div class="col-6">
        <form method="post" action="sql/sql-employee-update.php">
            ...
            <div class="form-group col-md-4">
                <?php include_once('dd_list/role-update.php'); ?>
            </div>
            ...
            <div class="form-group col-md-4">
                <?php include_once('dd_list/manager-update.php'); ?>
            </div>
