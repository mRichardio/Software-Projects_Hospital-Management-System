<?php
    ...
    $queryEmployee = "SELECT * FROM appointment
                        ...
                        WHERE appointment.PatientID = '$getPatientID'
...
?>
                    ...
                    <div class="staff-content">
                        <div class="list-toolbar">
                            <a class="new-appointment" href="appointment-create.php">New Appointment</a>
                        </div>
                        <div class ="listing">
                            <table>
                                <tr>
                            ...
                            <?php
                                while ($obj = $resultEmployee -> fetch_object()) {
                                    ...
                                    echo "<td><a class=\"update\" href=\"appointment-update.php?appID={$obj->AppointmentID}\">Update</a><br><a class=\"delete\" href=\"sql/sql-appointment-delete.php?appID={$obj->AppointmentID}\">Delete</a></td>";
                                    echo "</tr>";
                                }
                            ?>
                        </div>
