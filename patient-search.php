...
<html lang="en">
    <head>
        ...
        <title>HMS | Patient Search</title>
        ...
        <div class="container-fluid h-100 w-100">
            <div class="row h-100">
                ...
                <?php
                    ...
                    // query
                    $stmt = $conn->prepare( "SELECT * FROM patient WHERE PatientFirstName LIKE ?" );
                            ...
                            <div class="search-page">
                                <div class="search-form">
                                    <form>
                                        ...
                                        <div>
                                            <input class="button" type="submit" value="Search for a patient">
                                        </div>
                                    </form>
                                </div>
                                <div class="results">
                                    <?php
                                        if ( $validSearch ) {
                                            ...
                                            while ( $obj = $result->fetch_object() ) {
                                                echo "<h3>{$obj->PatientFirstName} {$obj->PatientLastName}</h3>";
                                                echo "<p><a href=\"patient-details.php?patID={$obj->PatientID}\">More Details</a></p>";
                                            }
                                        } else {
                                ...
                                <div>
                                    <a href="patient-list.php">Back</a>
                                </div>        
                            </div>
                        </div>
                    </div>
