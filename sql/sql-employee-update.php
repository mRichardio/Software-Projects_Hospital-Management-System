...
$stmt = $conn->prepare("UPDATE employee SET EmployeeFirstName='$first_name', EmployeeLastName='$last_name', RoleID='$role_id', SpecialityID='$speciality_id', EmployeeDoB='$birth_date', GenderID='$gender_id', EmployeeContactNumber='$phone_number', EmployeeEmail='$email', EmployeeAddress='$address', EmployeeHireDate='$hire_date', ManagerID='$manager_id' WHERE EmployeeID ='$getEmployeeID'");
