...
// prepare and bind
$stmt = $conn->prepare("INSERT INTO employee (EmployeeFirstName, EmployeeLastName, RoleID, SpecialityID, EmployeeDoB, GenderID, EmployeeContactNumber, EmployeeEmail, EmployeeAddress, EmployeeHireDate, LoginDetailsID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param('ssiississsi',$first_name, $last_name, $role_id, $speciality_id, $birth_date, $gender_id, $phone_number, $email, $address, $hire_date, $login_id);
...
<div class="form-done">
    <h2>Success</h2>
    <h4>Manager has been successfully added to the system.</h4>
